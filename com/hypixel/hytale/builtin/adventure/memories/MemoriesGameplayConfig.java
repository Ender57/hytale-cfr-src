...
public class MemoriesGameplayConfig {
    ...
    public static final BuilderCodec<MemoriesGameplayConfig> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(MemoriesGameplayConfig.class, MemoriesGameplayConfig::new).appendInherited(new KeyedCodec<int[]>("MemoriesAmountPerLevel", Codec.INT_ARRAY), (config, value) -> {
    ...
    }).addValidator(Validators.nonNull()).addValidator(Item.VALIDATOR_CACHE.getValidator()).add()).build();
