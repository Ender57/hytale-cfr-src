...
extends PositionProviderAsset {
    public static final BuilderCodec<VerticalEliminatorPositionProviderAsset> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(VerticalEliminatorPositionProviderAsset.class, VerticalEliminatorPositionProviderAsset::new, PositionProviderAsset.ABSTRACT_CODEC).append(new KeyedCodec<Integer>("MaxY", Codec.INTEGER, true), (asset, v) -> {
        asset.maxY = v;
    }, asset -> asset.maxY).add()).append(new KeyedCodec<Integer>("MinY", Codec.INTEGER, true), (asset, v) -> {
        asset.minY = v;
    }, asset -> asset.minY).add()).append(new KeyedCodec("Positions", PositionProviderAsset.CODEC, true), (asset, v) -> {
